...
const customEntryOutputConfigurations = {
	extension_theme_CSS_Animations: {
		entry: {
			'pre-optimized-min': ['../Media Library/Extension Themes/CSSAnimations/src/wow-init.js']
		},
		output: {
			path: path.resolve(__dirname, '../Media Library/Extension Themes/CSSAnimations'),
			library: 'extension_theme_CSSAnimations',
			libraryTarget: 'umd',
